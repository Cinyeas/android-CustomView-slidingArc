...
public class Constants {
     ...
     * APP文件夹路径
     */
    public static String FILE_FOLDER = Environment.getExternalStorageDirectory()
     ...
     * 截屏图片的位置
     */
    public static String FILE_SCREEN_FLODER = FILE_FOLDER + File.separator + "screenshoot";
    /**
     * 视频存放路径
     */
    public static String FILE_VIDEO_FLODER = FILE_FOLDER + File.separator + "video";
