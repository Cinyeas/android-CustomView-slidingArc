...
public abstract class StickerView extends FrameLayout {
    public static final String TAG = "com.poster.custom";
    private BorderView iv_border;
    private ImageView iv_scale;
    private ImageView iv_delete;
    private StickerViewIml mIml;
    ...
    private void init(Context context) {
        ...
        this.iv_scale.setVisibility(GONE);
        this.iv_delete.setVisibility(GONE);
            ...
            if (view.getTag().equals("DraggableViewGroup")) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        view.setTag(R.id.tag_view_x, (int) (StickerView.this.getX() + offsetX));
                        view.setTag(R.id.tag_view_y, (int) (StickerView.this.getY() + offsetY));
                        break;
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        ((View) view.getParent()).setTag(R.id.tag_view_rotation, getRotation());
    ...
    public interface StickerViewIml {
        void onViewActionDown(View view);

        void onDeleteView(View view);
    }

    public void setViewListener(StickerViewIml iml) {
        this.mIml = iml;
    }
